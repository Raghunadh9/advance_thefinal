    ...
    response.on("end", function () {
      ...
      <header class="header z-500  top-0 bg-green-600 text-white  shadow-md flex items-center justify-between px-8 py-02">
          ...
          <center>
              ...
              <img src="ganesh.png" alt="Ganesh" class="h-20">
          ...
          <center>
              <footer id="sticky-footer" class="f_ flex-shrink-0 py-4 mt-10 bg-green-600" >
                <div class="container text-center">
                  <small class="text-white font-bold text-md">Copyright &copy; Astrology</small><br>
                  <small class="text-white font-bold text-md">All Rights Reserved</small><br><br>
